...
all:
	...
	@genisoimage -b boot/grub/stage2_eltorito -no-emul-boot -boot-load-size 4 -boot-info-table -iso-level 3 -r -J -input-charset koi8-r -publisher "Peter Zotov <admin@story.osdev.ru>" -o disk.iso disk
